  ...
  return (
    <header id="overview" className="relative overflow-hidden bg-primary">
      <FadeIn delay={700} duration="slow" className="w-full">
        ...
        >
          <div className="absolute inset-0 bg-[#5F845E]/20" aria-hidden />
          <div
            className="absolute inset-0"
            aria-hidden
            style={{
              background:
                "linear-gradient(to right, rgb(45 75 44 / 0.60), rgb(65 95 63 / 0.35) 45%, transparent 72%)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgb(45 75 44 / 0.50), transparent 55%, rgb(95 132 94 / 0.18))",
            }}
          />
